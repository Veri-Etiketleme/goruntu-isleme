...
from FaceMaskDetection.load_model.keras_loader import load_keras_model, keras_inference
from keras.utils import plot_model

model = load_keras_model('./FaceMaskDetection/models/face_mask_detection.json', './FaceMaskDetection/models/face_mask_detection.hdf5')
...
def inference(image,
    ...
    for idx in keep_idxs:
        ...
        if draw_result:
            ...
            cv2.putText(image, "%s: %.2f" % (id2class[class_id], conf), (startX, endY-40),
...
def run_on_video(frame, conf_thresh=0.5):
