...
from facial.vggface import VGGFace
...
def Face(train=False):
    ...
    # race 0~4
    output_r = Dense(2, activation='softmax', name='predications_race')(base_output)
...
if __name__ == '__main__':
    ...
    #model.summary()
    #plot_model(model, to_file='model_ori.png', show_shapes=True)