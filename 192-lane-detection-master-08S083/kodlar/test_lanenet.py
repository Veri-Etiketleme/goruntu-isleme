...
"""
test LaneNet model on single g
"""
import argparse
...
def test_lanenet(image_path, weights_path):
    ...
    with sess.as_default():
        ...
        lanenet_postprocess.plot_figures([
            {'name': 'mask_image', 'image': mask_image[:, :, (2, 1, 0)]},
            {'name': 'src_image', 'image': image_vis[:, :, (2, 1, 0)]},
            {'name': 'instance_image', 'image': embedding_image[:, :, (2, 1, 0)]},
            {'name': 'binary_image', 'image': binary_seg_image[0] * 255, 'kwargs': {'cmap': 'gray'} },
